.PHONY: test doctor live schedule logs bot web-api web-ui web-ui-build app security-check security-check-extended docker-build docker-up docker-down docker-logs docker-ps docker-restart
